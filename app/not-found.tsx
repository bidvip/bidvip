      ...
      <div className="relative z-10 flex flex-1 items-center justify-center px-6 text-center">
        <div className="max-w-md">
          ...
          <div className="inline-flex items-center gap-2 text-xs font-black tracking-widest uppercase mb-6"
            ...
            <span className="w-1.5 h-1.5 rounded-full" style={{ background: 'var(--v-rozsa)' }} />
            Channel 404 — Off Air
          </div>
          <h1 className="text-4xl font-black mb-3" style={{ letterSpacing: '-0.04em' }}>No signal.</h1>
          <p className="text-base leading-relaxed mb-8" style={{ color: 'var(--v-szoveg-2)' }}>
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <Link href="/aukciosHaz"
              ...
              style={{ background: 'var(--v-rozsa)', color: '#fff', boxShadow: '0 0 24px rgba(244,63,94,0.25)' }}
