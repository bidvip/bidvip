...
export async function POST(req: NextRequest) {
  ...
  const { nev, rovid_leiras, reszletes_leiras, kategoria, fajlSzovegek = [] } = await req.json()
...
- Detailed description: ${reszletes_leiras}${dokumentumSzoveg}

Rules — reject if:
1. Content is clearly fake, nonsensical, or test data (e.g. "asdf", "test 123", "hello world")
2. The idea is illegal, harmful, or violates basic marketplace rules
