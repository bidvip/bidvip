...
/** Modul szinten, mert a strukturált adat is ebből dolgozik. */
const GYIK: [string, string][] = [
    ...
    <footer className="mx-auto max-w-6xl px-6 py-10" style={{ borderTop: '1px solid var(--v-vonal)' }}>
      <div className="flex flex-wrap items-center justify-between gap-5">
        ...
        <nav className="flex flex-wrap gap-x-6 gap-y-2">
          {[['Tételek', '#tetelek'], ['Menete', '#menete'], ['Aukciósház', '/aukciosHaz'], ['ÁSZF', '/aszf'], ['Adatvédelem', '/adatvedelem']].map(([c, h]) => (
